                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" action="functions/fornecedores_imagem.php"
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        $pegaid = (int) $_GET['id'];
                                        $sql = "select * FROM fornecedores where id = '$pegaid'";
                                        ...
                                        while($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            {
                                                echo "<img src='uploads/fornecedores/$row[imagem]' class='img-fluid'>";
                                                echo "<input type='hidden' name='id' value='$row[id]'>";
                                                echo "<br/><br/>";
                                            }
                                        }
