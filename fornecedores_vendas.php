                ...
                <nav class="navbar-custom">
                    ...
                    <ul class="list-inline menu-left mb-0">
                        ...
                        <li class="hide-phone list-inline-item app-search">
                            <h3 class="page-title">Painel de Gerenciamento :: Fornecedores :: Produtos vendidos</h3>
                        </li>
                    </ul>
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Visualizar vendas</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<span style='font-weight: bold'>Item: $row[ptitulo]</span> - Valor de compra: R$ $row[pvalorcompra]";
