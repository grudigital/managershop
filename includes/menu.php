    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="abrircaixa.php" class="waves-effect"><i
                                class="mdi mdi-format-list-bulleted-type"></i><span> Abrir caixa </span></a>
                </li>
                <li class="menu-title">Cadastros</li>
                <li>
                    <a href="clientes.php" class="waves-effect"><i class="mdi mdi-album"></i><span>Clientes</span></a>
                </li>
                <li>
                    <a href="fornecedores.php" class="waves-effect"><i class="mdi mdi-album"></i><span>Fornecedores</span></a>
                </li>
                <li>
                    <a href="produtos.php" class="waves-effect"><i class="mdi mdi-album"></i><span>Produtos</span></a>
                </li>
                <li>
                    <a href="produtos_parametros.php" class="waves-effect"><i class="mdi mdi-album"></i><span>Produtos / Parâmetros</span></a>
                </li>
                <li>
                    <a href="usuarios.php" class="waves-effect"><i class="mdi mdi-album"></i><span>Usuários</span></a>
                </li>
