...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Ago-2020 às 19:52
...
CREATE TABLE `caixa` (
  ...
  `movimento` int(10) NOT NULL COMMENT '1.entrada / 2. saida',
  `operacao` int(10) NOT NULL COMMENT '1.venda / 2.despesa / 3.sangria',
  ...
  `despesadescricao` varchar(120) NOT NULL,
  `status` int(5) NOT NULL COMMENT '1.ativo / 2.cancelado',
...
(1, 'Tenis da Nike', 'calcado', 'gdsfg2', 'gdsfg2', 'gdsfg2', 'dfsgdfs', 'gdsfg2', 'gdsfg2', 'gdsfg2', 'gdsfg2', 0, 0, '2020-08-26 13:25:44'),
(2, 'Chinelo da Adidas', 'calcado', '27272272727', '10', '12', '12', '12', 'sala 2', '150', '180', 54, 1, '2020-08-05 12:20:07');
