                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $sqlentradas = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, sum(valor) as valorrecebidomes, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where movimento = '1' and MONTH(datatransacao) = '12'";
                                                    ...
                                                    while ($rowentradas = mysqli_fetch_assoc($resultentradas)) {
                                                        ...
                                                        if($totalmes < '0'){
                                                            echo "<div class='alert alert-danger' role='alert'>Dezembro (Entradas: R$ $rowentradas[valorrecebidomes] - Saídas: R$ $row[valorpagarmes] - <span style='font-weight: bold'> Balanço do mês: R$ $totalmes </span>)</div>";
                                                        }
                                                        else{
                                                            echo "<div class='alert alert-primary' role='alert'>Dezembro (Entradas: R$ $rowentradas[valorrecebidomes] - Saídas: R$ $row[valorpagarmes] - <span style='font-weight: bold'> Balanço do mês: R$ $totalmes </span>)</div>";
                                                        }
                                                ...
                                                <?php
                                                require("connections/conn.php");
                                                $sql = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where MONTH(datatransacao) = '12'";
                                                $result = mysqli_query($conn, $sql);
