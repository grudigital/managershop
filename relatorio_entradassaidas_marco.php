                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                $sql = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, sum(valor) as valorpagarmes, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where movimento = '2' and operacao = '2' and MONTH(datatransacao) = '03'";
                                                $result = mysqli_query($conn, $sql);


                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $sqlentradas = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, sum(valor) as valorrecebidomes, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where movimento = '1' and MONTH(datatransacao) = '03'";
                                                    ...
                                                    while ($rowentradas = mysqli_fetch_assoc($resultentradas)) {
                                                        ...
                                                        if($totalmes < '0'){
                                                            echo "<div class='alert alert-danger' role='alert'>Março (Entradas: R$ $rowentradas[valorrecebidomes] - Saídas: R$ $row[valorpagarmes] - <span style='font-weight: bold'> Balanço do mês: R$ $totalmes </span>)</div>";
                                                        }
                                                        else{
                                                            echo "<div class='alert alert-primary' role='alert'>Março (Entradas: R$ $rowentradas[valorrecebidomes] - Saídas: R$ $row[valorpagarmes] - <span style='font-weight: bold'> Balanço do mês: R$ $totalmes </span>)</div>";
                                                        }
                                                ...
                                                <?php
                                                require("connections/conn.php");
                                                $sql = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where MONTH(datatransacao) = '03'";
                                                $result = mysqli_query($conn, $sql);
