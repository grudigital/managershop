                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-12">
                                                ...
                                                $sql = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, sum(valor) valorvendidodia, formapagamento,parcelas,despesadescricao,status,datatransacao, day(datatransacao) as diatransacao from caixa where movimento = '1' and MONTH(datatransacao) = '06' group by DAY(datatransacao) order by datatransacao desc";
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    $sqlselecionacompras2 = "select id, movimento, operacao, valor,cliente,vendedor,fornecedor, formapagamento,parcelas,despesadescricao,status,datatransacao from caixa where movimento = '1' and MONTH(datatransacao) = '06' and day(datatransacao) = '$row[diatransacao]'";
