                        ...
                        <div class="col-12">
                            <div class="card m-b-20">
                                <form class="card-body" enctype="multipart/form-data"
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-4">
                                                ...
                                                <p class="text-muted m-b-30 font-14">Processar venda</p>
                                            </div>
                                            <div class="col-6"></div>
                                            <div class="col-2">
                                    ...
                                    <div class="form-group row">
                                        <label for="example-text-input" class="col-sm-2 col-form-label">Codigo do Cliente</label>
                                        <div class="col-sm-10">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <button style="float: right" type='submit' class='btn btn-info'>Processar venda</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
